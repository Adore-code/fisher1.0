"""
 Created by Tang on 2020/2/16 16:46
"""

from wtforms import StringField, PasswordField, Form
from wtforms.validators import DataRequired, Length, Length, Email, ValidationError, EqualTo
...
class RegisterForm(Form):
    ...
    password = PasswordField('密码', validators=[
        DataRequired(), Length(6, 20, message='密码不可以为空')])
